  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 pt-8 md:pt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
        <motion.div variants={itemAnim} className="relative z-10 order-2 lg:order-1">
          ...
          <div className="relative group max-w-lg">
            ...
            <div className="relative flex items-center bg-[#050505] border border-white/10 rounded-xl p-2 pr-2">
              ...
              <button onClick={handleCopy} className="flex items-center gap-2 bg-white text-black px-6 py-3 rounded-lg font-bold hover:bg-cyan-50 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.3)]">
        ...
        <motion.div variants={itemAnim} className="relative h-[300px] md:h-[400px] w-full order-1 lg:order-2 flex items-center justify-center">
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="relative p-8 rounded-3xl bg-[#111]/50 border border-white/10 overflow-hidden group hover:border-white/20 transition-all backdrop-blur-sm">
               ...
               <div className="relative z-10">
                  ...
                  <h3 className="text-4xl font-black text-white mb-2">${totalEarnings.toLocaleString(undefined, { minimumFractionDigits: 2 })}</h3>
            ...
            <div className="relative p-8 rounded-3xl bg-[#111]/50 border border-white/10 overflow-hidden group hover:border-white/20 transition-all backdrop-blur-sm">
               ...
               <div className="relative z-10">
                  ...
                  <h3 className="text-4xl font-black text-white mb-2">{networkSize}</h3>
            ...
            <div className="relative p-8 rounded-3xl bg-[#111]/50 border border-white/10 overflow-hidden group hover:border-white/20 transition-all backdrop-blur-sm">
               ...
               <div className="relative z-10">
                  ...
                  <h3 className="text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500 mb-2">{currentTier}</h3>
